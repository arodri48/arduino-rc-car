...
CarControlManager::CarControlManager(RadarManager *radarManager, MotorManager *motorManager, MpuManager *mpuManager, TimeManager *timeManager)
{
    this->radarManager = radarManager;
    this->motorManager = motorManager;
    this->mpuManager = mpuManager;
